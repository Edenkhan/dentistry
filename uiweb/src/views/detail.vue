<template>
  <div class="detail">
    ...
    <div class="chdoc" v-show='dshow'>
      ...
      />
      <div class="cdoc">
        <van-picker show-toolbar title=" " :columns="columns" confirm-button-text=' ' cancel-button-text=' '
                    @change="onChange" @confirm='onConfirm' ref='zg'/>
        ...
        WeixinJSBridge.invoke(
            ...
            function (res) {
              if (res.err_msg == "get_brand_wcpay_request:ok") {
                ...
                this.$router.push({
                  path: '/succ',
                  query: {id: 0, orderId: data.id, productId: this.productId, notfar: undefined}
                });
                location.reload();
              }
            }
